...
export default function ServiceInfo() {
    return (
        <div className="bg-transparent text-white grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-[10px] lg:gap-[1px]">
            <Section className="flex flex-col justify-between p-6 border border-neutral-900">
            <div>
                ...
                <div className="relative flex h-100 bg-black overflow-hidden">
                    {/* Back Card */}
                    <div
            ...
            <Section className="flex flex-col justify-between border border-neutral-900">
                <div className="p-6">
                ...
                <div className="flex justify-center items-center w-full">
                    <div className="p-4 w-100 bg-neutral-900 border border-neutral-800 shadow-[0px_0px_30px_rgba(0,204,0,0.3)] rounded-md text-white flex justify-center gap-4 items-center">
                        <div className='bg-green-700 p-3 rounded-full'><FaDollarSign size={20}/></div>
                        <div>
                            <p className='text-sm'>No extra charges on any authentication feature</p>
                            <p className='text-sm text-gray-700'>Any addition authentication feature have no extra charges</p>
                        </div>
                    </div>
                </div>
                <OverlappingCards/>
